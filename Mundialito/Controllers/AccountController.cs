...
namespace Mundialito.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public AccountController()
            : this(new UserManager<MundialitoUser>(new UserStore<MundialitoUser>(new MundialitoContext())), Startup.OAuthOptions.AccessTokenFormat)
        {
        }

        public AccountController(UserManager<MundialitoUser> userManager, ISecureDataFormat<AuthenticationTicket> accessTokenFormat)
        {
