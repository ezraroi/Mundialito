...
namespace Mundialito.Providers
{
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        private readonly Func<UserManager<MundialitoUser>> _userManagerFactory;

        public ApplicationOAuthProvider(string publicClientId, Func<UserManager<MundialitoUser>> userManagerFactory)
        {
